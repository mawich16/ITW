...
var vm = function (Id, Acronym) {
    ...
    //--- Page Events
    self.activate = function (Acronym) {
        console.log('CALL: getTeams...');
        var pg = getUrlParameter('id');
        var acronym = getUrlParameter('Acronym');
        var composedUri = self.baseUri() + pg + '?acronym=' + acronym;
    ...
    console.log(pg);
    if (pg == undefined)
        self.activate(1, self.Acronym);
    else {
        self.activate(pg, self.Acronym);
    }
